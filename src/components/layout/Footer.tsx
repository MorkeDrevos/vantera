    ...
    <footer className="mt-16 w-full">
      ...
      <div className="relative w-full">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(251,251,250,0.70),rgba(251,251,250,0.96))]" />
          <div className="absolute inset-x-0 top-0 h-[260px] bg-[radial-gradient(1400px_420px_at_50%_0%,rgba(231,201,130,0.14),transparent_62%)]" />
          <div className="absolute inset-x-0 top-0 h-[280px] bg-[radial-gradient(1200px_420px_at_85%_10%,rgba(139,92,246,0.06),transparent_66%)]" />
        ...
        {/* FULL-BLEED PLATE (edge-to-edge) */}
        <div
          className={cx(
            'relative w-full',
            'bg-white/72 backdrop-blur-[18px]',
            'ring-1 ring-inset ring-[color:var(--hairline)]',
            'shadow-[0_36px_120px_rgba(11,12,16,0.10)]',
          )}
        >
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute inset-0 bg-[radial-gradient(1200px_360px_at_18%_0%,rgba(231,201,130,0.12),transparent_60%)]" />
            <div className="absolute inset-0 bg-[radial-gradient(1100px_360px_at_86%_10%,rgba(139,92,246,0.05),transparent_62%)]" />
          ...
          {/* Content stays premium and aligned */}
          <div className={cx('relative py-10 sm:py-12', CONTENT)}>
            {/* Brand row */}
