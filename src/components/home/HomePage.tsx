...
function HeroShine() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div className="absolute right-[-70px] top-[-50px] opacity-[0.08] blur-[0.2px]">
              ...
              >
                <div
                  className={[
                    ...
                    item.tone === 'gold'
                      ? 'bg-[radial-gradient(520px_180px_at_20%,rgba(232,190,92,0.12),transparent_60%)]'
                      : item.tone === 'aqua'
                        ? 'bg-[radial-gradient(520px_180px_at_20%,rgba(62,196,255,0.10),transparent_60%)]'
                        : item.tone === 'violet'
                          ? 'bg-[radial-gradient(520px_180px_at_20%,rgba(120,76,255,0.12),transparent_60%)]'
                          : 'bg-[radial-gradient(520px_180px_at_20%,rgba(255,255,255,0.08),transparent_60%)]',
                  ].join(' ')}
                />
                <div className="relative">
