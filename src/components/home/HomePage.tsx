...
function MockListing({
  ...
  return (
    <div className="group relative overflow-hidden rounded-[26px] border border-white/10 bg-white/[0.02] shadow-[0_34px_110px_rgba(0,0,0,0.55)]">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 opacity-70 [background:radial-gradient(900px_300px_at_25%_10%,rgba(255,255,255,0.06),transparent_60%)]" />
        <div className="absolute inset-0 opacity-60 [background:radial-gradient(900px_300px_at_85%_20%,rgba(120,76,255,0.10),transparent_60%)]" />
      </div>
      ...
      <div className="relative h-44 overflow-hidden sm:h-48">
        ...
        <div className="absolute left-4 top-4 rounded-full border border-white/10 bg-black/35 px-3 py-1 text-[11px] text-zinc-200">
          Featured
        </div>
      </div>
      ...
      <div className="relative p-5">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <div className="rounded-full border border-white/10 bg-white/[0.03] px-3 py-2 text-xs text-zinc-200 transition group-hover:bg-white/[0.05]">
            View details
          </div>
        </div>
      </div>
...
export default function HomePage() {
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <div>
                          ...
                          <div className="mt-1 text-xs text-zinc-500">
                            Start with a city. Then open property intelligence.
                          </div>
                        </div>
  ...
  Browse homes, then open the Truth Card - value, liquidity, risk and leverage in seconds.
                      ...
                      <div className="mt-4 grid gap-2 sm:grid-cols-2">
                        <div className="rounded-2xl border border-white/10 bg-black/20 px-3 py-2">
                          ...
                          <div className="mt-1 text-[12px] text-zinc-200">
                            “Safe, undervalued, near good schools, with upside in 5 years.”
                          </div>
                        </div>
                        <div className="rounded-2xl border border-white/10 bg-black/20 px-3 py-2">
                          <div className="text-[10px] font-semibold tracking-[0.22em] text-zinc-500">YOU GET</div>
                          <div className="mt-1 text-[12px] text-zinc-200">
                            Homes, timing guidance and leverage clarity
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="mt-5 grid max-w-2xl gap-3 sm:grid-cols-3">
                  <Pillar title="Reality" body="Value is modelled from signals, not asking prices." />
                  <Pillar title="Liquidity" body="We estimate how long it may take to sell and why." />
                  <Pillar title="Integrity" body="Anti-gaming rules protect the surface from manipulation." />
                </div>
              </div>
                ...
                <div className="relative overflow-hidden rounded-[30px] border border-white/10 bg-black/22 p-5 shadow-[0_42px_130px_rgba(0,0,0,0.70)] sm:p-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-5 rounded-2xl border border-white/10 bg-white/[0.02] px-4 py-3 text-[12px] text-zinc-300">
                      ...
                      <span className="text-zinc-500"> Intelligence expands as coverage becomes real.</span>
                    </div>
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-2">
                      <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-4 text-sm text-zinc-300 shadow-[0_22px_70px_rgba(0,0,0,0.55)]">
                        <div className="text-[11px] tracking-[0.18em] text-zinc-400">PROPERTY DNA</div>
                        <div className="mt-2 text-zinc-200">True value, risk and leverage</div>
                        <div className="mt-1 text-xs text-zinc-500">A universal intelligence layer for each home.</div>
                      </div>
      ...
      <div className="mx-auto w-full max-w-7xl px-5 pb-16 sm:px-8">
        {/* Featured properties (portal vibe) */}
        <section className="mt-10 sm:mt-12">
          ...
          <div className="mt-4 rounded-[26px] border border-white/10 bg-white/[0.02] p-5 text-sm text-zinc-300 shadow-[0_30px_95px_rgba(0,0,0,0.50)]">
            ...
            <span className="text-zinc-500">
              {' '}
              It shows value, liquidity and risk in a buyer-seller friendly way.
            </span>
          </div>
        </section>
        ...
        <section className="mt-14 sm:mt-16">
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            <FeatureCard
              ...
              bullets={[
                'Tracks market velocity and reductions',
                'Separates value from persuasion',
                'Protects buyers and sellers from bad pricing',
              ]}
            />
            <FeatureCard
              eyebrow="AI-native"
              ...
              bullets={[
                ...
                'Gives “wait or buy” clarity when it matters',
              ]}
            />
            <FeatureCard
              eyebrow="Integrity"
              title="Anti-gaming by design"
              body="The truth layer is protected. Manipulation guards and audit trails keep the surface loyal to reality even when incentives push the other way."
              bullets={[
                'Detects coordinated overpricing patterns',
        ...
        <section className="mt-14 sm:mt-16">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            ...
            <Pillar title="Confidence score" body="Transparent confidence that tightens as data strengthens." />
          </div>
        </section>
