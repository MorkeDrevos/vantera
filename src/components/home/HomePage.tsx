  ...
  return (
    <div className="mb-4 flex flex-col gap-3 sm:mb-6 sm:flex-row sm:items-end sm:justify-between">
      <div className="min-w-0">
        <div className="text-[11px] font-semibold tracking-[0.26em] text-[color:var(--ink-3)] uppercase">{title}</div>
        ...
        {items.map((it) => (
          ...
          >
            ...
            <div className="relative flex items-start justify-between gap-2">
              <div className="min-w-0">
                <div className="text-[10px] font-semibold tracking-[0.26em] text-[color:var(--ink-3)]">{it.k}</div>
...
function HotLocations({ cities }: { cities: RuntimeCity[] }) {
  ...
  return (
    <div className={cx('relative overflow-hidden rounded-[28px] p-5 sm:p-6', GLASS_SOFT)}>
      <div className="pointer-events-none absolute inset-0">
      ...
      <div className="relative">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <div className="mt-2 text-[16px] font-semibold tracking-[-0.02em] text-[color:var(--ink)]">
              Fast entry points into the index
            </div>
            <div className="mt-1 text-sm leading-relaxed text-[color:var(--ink-2)]">
              Hand-picked for momentum and liquidity. Search returns soon.
            </div>
          </div>
          ...
          <a
            href="#explore-index"
            className={cx(
              'hidden sm:inline-flex items-center justify-center rounded-full px-4 py-2 text-[12px] font-semibold transition',
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {hot.map((c) => (
            <a
              ...
              href={`/city/${c.slug}`}
              className={cx(
                'inline-flex items-center gap-2 rounded-full px-3.5 py-2 text-[12px] font-medium transition',
                'bg-white/70 hover:bg-white/85',
                'ring-1 ring-inset ring-[color:var(--hairline)] hover:ring-[rgba(11,12,16,0.18)]',
                'text-[color:var(--ink)]',
              )}
            >
              <span className="h-1.5 w-1.5 rounded-full bg-[rgba(11,12,16,0.35)]" />
              <span className="max-w-[22ch] truncate">{c.name}</span>
            </a>
          ))}
          <a
            href="#explore-index"
            className={cx(
              'inline-flex items-center justify-center rounded-full px-3.5 py-2 text-[12px] font-semibold transition',
  ...
  return (
    <div className={cx('relative overflow-hidden rounded-[32px] p-6 sm:p-10', GLASS)}>
      ...
      <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          <div className="text-[11px] font-semibold tracking-[0.26em] text-[color:var(--ink-3)] uppercase">Private access</div>
...
export default function HomePage({ cities }: { cities: RuntimeCity[] }) {
  ...
  return (
    <Shell>
      {/* =====================================================
          HERO - modernised premium, OmniSearch removed
         ===================================================== */}
            ...
            <div className="relative px-6 py-10 sm:px-10 sm:py-14 lg:px-14 lg:py-18 2xl:px-20 2xl:py-20">
              <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
                ...
                <div className="lg:col-span-7">
                  ...
                  {/* OmniSearch removed - replace with hot locations + intent console */}
        ...
        <div className={WIDE}>
          ...
          <div className={cx('relative overflow-hidden rounded-[34px] p-5 sm:p-7', GLASS)}>
            ...
            <div className="relative flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <div className="text-[11px] font-semibold tracking-[0.26em] text-[color:var(--ink-3)] uppercase">Cities</div>
