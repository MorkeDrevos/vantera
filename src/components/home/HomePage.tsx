...
import TrustMarquee, { type TrustLogo } from '@/components/trust/TrustMarquee';
  ...
  return (
    <section className="relative w-full pb-12 pt-12 sm:pb-16 sm:pt-14">
      <div className="relative w-full overflow-hidden border-y border-white/10 bg-[linear-gradient(to_bottom,rgba(255,255,255,0.040),rgba(255,255,255,0.012),rgba(0,0,0,0.66))] shadow-[0_55px_150px_rgba(0,0,0,0.72)]">
        ...
        {/* Wider than 7xl: this is the big fix for "page feels boxed" */}
        <div className="relative mx-auto w-full max-w-[1600px] px-5 py-14 sm:px-8 sm:py-16 lg:py-20">
...
export default function HomePage() {
  ...
  return (
    <PageShell
      contentWidth="wide"
      fullBleedChildren
      fullBleedHero={<HeroSection regionCount={regionCount} timezoneCount={timezoneCount} />}
    >
      ...
      {/* BODY (wide container, not boxed to 7xl anymore) */}
      <div className="mx-auto w-full max-w-[1600px] px-5 pb-16 sm:px-8">
