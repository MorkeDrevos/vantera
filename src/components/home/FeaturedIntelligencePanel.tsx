  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-start gap-3">
        ...
        <span className={cx('ml-auto inline-flex items-center gap-2 rounded-full px-2 py-1 text-[10px] tracking-[0.22em] uppercase', RING, active ? 'bg-white/88 text-[color:var(--ink-2)]' : 'bg-white/62 text-[color:var(--ink-3)]')}>
