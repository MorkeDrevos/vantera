...
export default async function ListingDetailPage({
  ...
  if (!listing) {
    // You can either render a custom "not found" UI OR use notFound().
    // Keeping your custom UI here.
    return (
      <div className="min-h-screen bg-zinc-950 text-zinc-100">
        <div className="mx-auto w-full max-w-3xl px-5 py-14 sm:px-8">
          <div className="rounded-[28px] border border-white/10 bg-white/5 p-7">
            ...
            <p className="mt-3 text-sm text-zinc-300">This listing ID is not in the mock dataset.</p>
